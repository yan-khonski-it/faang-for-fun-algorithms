package com.yk.faang.algorithms.sliding_window_maximum;
...
class Solution {
  ...
  public int[] maxSlidingWindow(int[] nums, int k) {
    ...
    Deque<Integer> indexesDeque = new ArrayDeque<>();
...
class Main {
  ...
  public static void main(String[] args) {
    ...
    int[] res2 = runTestCaseWithTimer(() -> { // 13 ms
      return solution.maxSlidingWindow(array2, k2);
    });
    ...
    int[] res3 = runTestCaseWithTimer(() -> { // 3 ms
      return solution.maxSlidingWindow(array3, k3);
    });
