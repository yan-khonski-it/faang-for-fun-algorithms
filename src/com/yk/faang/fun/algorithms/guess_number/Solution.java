...
class Solution extends GuessGame {
  ...
  public static void main(String[] args) {
    ...
    boolean equal = actualGuessedNumber == solution.guessedNumber;
    System.out.println("Original guessed number: " + solution.guessedNumber +
        ", actualGuessedNumber: " + actualGuessedNumber + ". Equal: " + equal + ".");
  }
}
